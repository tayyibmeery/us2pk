<template>
  <FormModal :isOpen="isOpen" :title="formData.id ? 'Edit Team Member' : 'Add Team Member'"
    :subtitle="formData.id ? 'Update the team member details below.' : 'Fill in the details to add a new team member.'"
    ...
    <template #fields>
      <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <div>
          ...
          <input v-model="formData.position" type="text" placeholder="e.g. CEO & Co-Founder"
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <textarea v-model="formData.bio" rows="3" placeholder="Team member biography"
        ...
        <div>
          ...
          <input v-model="formData.facebook" type="text" placeholder="https://facebook.com/..."
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        </div>
        ...
        <div>
          ...
          <input v-model="formData.twitter" type="text" placeholder="https://twitter.com/..."
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        </div>
        ...
        <div>
          ...
          <input v-model="formData.instagram" type="text" placeholder="https://instagram.com/..."
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        </div>
        ...
        <div>
          ...
          <input v-model="formData.linkedin" type="text" placeholder="https://linkedin.com/..."
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        </div>
...
import type { TeamMember } from '@/stores/teamMemberStore'
...
const formData = ref<Partial<TeamMember>>({
  name: '',
  position: '',
  bio: '',
  image: null,
...
const save = () => {
  ...
  const fields = ['name', 'position', 'bio', 'facebook', 'twitter', 'instagram', 'linkedin']
