<template>
  <FormModal :isOpen="isOpen" :title="formData.id ? 'Edit Why Us Section' : 'Add Why Us Section'"
    :subtitle="formData.id ? 'Update the why us section details below.' : 'Fill in the details to add a new why us section.'"
    ...
    <template #fields>
      <div class="grid grid-cols-1 gap-5">
        ...
        <div>
          ...
          <input v-model="formData.title" type="text" placeholder="e.g. Why Choose US2PK"
        ...
        <div>
          ...
          <textarea v-model="formData.content" rows="3" placeholder="Main content"
        ...
        <div>
          ...
          <textarea v-model="featuresJson" rows="4" placeholder='["Cargo express", "Secure Services", "Cost savings"]'
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">JSON array of feature strings</p>
        </div>
...
import type { WhyUsSection } from '@/stores/whyUsSectionStore'

const props = defineProps<{
  isOpen: boolean
  initialData?: WhyUsSection | null
}>()
...
const formData = ref<Partial<WhyUsSection>>({
  title: '',
  content: '',
  image: null,
  features: [],
