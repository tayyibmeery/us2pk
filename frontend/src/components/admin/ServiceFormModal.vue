<template>
  <FormModal :isOpen="isOpen" :title="formData.id ? 'Edit Service' : 'Add Service'"
    :subtitle="formData.id ? 'Update the service details below.' : 'Fill in the details to add a new service.'"
    ...
    <template #fields>
      <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <div class="sm:col-span-2">
          ...
          <input v-model="formData.title" type="text" placeholder="e.g. Air Freight"
        ...
        <div class="sm:col-span-2">
          ...
          <input v-model="formData.subtitle" type="text" placeholder="e.g. Fast & Reliable"
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <textarea v-model="formData.content" rows="3" placeholder="Service description"
        ...
        <div>
          ...
          <input v-model="formData.icon" type="text" placeholder="e.g. flaticon-airplane"
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        ...
        <div>
          ...
          <input v-model="formData.link" type="text" placeholder="e.g. /services/air-freight"
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        </div>
...
const save = () => {
  ...
  const fields = ['title', 'subtitle', 'content', 'icon', 'link']
