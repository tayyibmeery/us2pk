<!-- frontend/src/views/admin/profile/AdminProfileSettings.vue -->
<template>
  <div class="space-y-6">
    <div class="flex flex-wrap items-center justify-between gap-4">
      <div>
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Security</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Manage your administrator account password</p>
      </div>
      ...
      <form @submit.prevent="updatePassword" class="space-y-4">
        <div>
          ...
          <input v-model="passwordForm.current_password" type="password"
            class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
        ...
        <button type="submit" :disabled="passwordSubmitting"
          class="w-full px-4 py-2.5 text-sm font-medium text-white bg-purple-500 rounded-lg hover:bg-purple-600 transition disabled:opacity-50 shadow-sm hover:shadow-md">
